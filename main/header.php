<div class="header">
    ...
    <ul>
        <a class="navbar-brand" href="#">
            <img src="https://www.nicepng.com/png/full/19-192021_mobile-phone-logo-design-checking-my-phone-tiredriveeasyco.png"
                class="logoOK" />
        </a>
        <li><a href="main.php">
		...
		?>
        <li><a href="../template/first_template_main.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-android"
                    viewBox="0 0 16 16">
                    <path
